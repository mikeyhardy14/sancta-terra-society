        ...
        <div className="medieval-content">
          ...
          <div className="text-center mb-8">
            <div className="medieval-crest mb-6">
              <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center mx-auto border-3 sm:border-4 shadow-lg" style={{backgroundColor: 'var(--medieval-brown)', borderColor: 'var(--earthy-green)'}}>
                <span className="text-xl sm:text-2xl md:text-3xl font-bold" style={{color: 'var(--medieval-parchment)'}}>✠</span>
              </div>
            </div>
          ...
          <div className="medieval-text-layout">
            <div className="medieval-column">
              ...
              <p className="medieval-text">
                <span className="text-4xl float-left leading-none pr-2 font-bold" style={{color: 'var(--earthy-green)'}}>T</span>o practice our unique calling as members of the Catholic laity to sanctify the temporal order through the specific pietistic practice of building public shrines to Christ, Mary His mother, and the angels and saints. We shall accomplish this through four distinct activities which form the pillars of our sacred mission.
              </p>
              ...
              <h3 className="font-bold text-lg mb-3 mt-6" style={{color: 'var(--earthy-green)'}}>PRIMA OPERA</h3>
              <p className="medieval-text">
              ...
              <h3 className="font-bold text-lg mb-3 mt-4" style={{color: 'var(--earthy-green)'}}>SECUNDA OPERA</h3>
              <p className="medieval-text">
            ...
            <div className="medieval-column">
              ...
              <p className="medieval-text">
                <span className="text-4xl float-left leading-none pr-2 font-bold" style={{color: 'var(--earthy-green)'}}>O</span>ur Society operates through four principal activities, each contributing to the greater work of bringing the sacred into the public square. These endeavors represent the culmination of centuries of Catholic tradition in the building and maintenance of sacred spaces.
              </p>

              <h3 className="font-bold text-lg mb-3 mt-6" style={{color: 'var(--earthy-green)'}}>TERTIA OPERA</h3>
              <p className="medieval-text">
              ...
              <h3 className="font-bold text-lg mb-3 mt-4" style={{color: 'var(--earthy-green)'}}>QUARTA OPERA</h3>
              <p className="medieval-text">
              ...
              <div className="medieval-notice mt-6">
                <h3 className="font-bold text-lg mb-3" style={{color: 'var(--earthy-green)'}}>VOCATIO NOSTRA</h3>
